...
const APP_SHELL=["./","./index.html","./styles.css?v=103","./app.js?v=103","./assets/neon-salvager-weapons.png","./assets/fish-species-freshwater.png","./assets/fish-species-ocean.png","./assets/fish-species-legendary.png","./assets/fish-species-arcade.png","./assets/fish-species-bosses.png","./manifest.json","./icons/gubuntu.ico","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png"];
